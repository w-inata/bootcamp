					...
					<div class="m-stack__item m-brand  m-brand--skin-dark ">
						<div class="m-stack m-stack--ver m-stack--general">
							<div class="m-stack__item m-stack__item--middle m-brand__logo">
								<a href="<?php echo e(route('produksiList')); ?>" class="m-brand__logo-wrapper">
									<h3>Bootcamp</h3>
								</a>
							</div>
									...
									<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
										<a href="#" class="m-nav__link m-dropdown__toggle">
											<span class="m-topbar__userpic">
												<img src="<?php echo e(asset('assets/app/media/img/users/user4.jpg')); ?>" class="m--img-rounded m--marginless m--img-centered" alt=""/>
											</span>
												...
												<div class="m-dropdown__header m--align-center" style="background: url(<?php echo e(asset('assets/app/media/img/misc/user_profile_bg.jpg')); ?>); background-size: cover;">
													<div class="m-card-user m-card-user--skin-dark">
														<div class="m-card-user__pic">
															<img src="<?php echo e(asset('assets/app/media/img/users/user4.jpg')); ?>" class="m--img-rounded m--marginless" alt=""/>
														</div>
	...
	>
					<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
						<li class="m-menu__item " aria-haspopup="true" >
							<a  href="<?php echo e(route('produksiList')); ?>" class="m-menu__link ">
				...
				<div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
					<div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
						<span class="m-footer__copyright">
							<?php echo e(date('Y')); ?> &copy; Development By
...
</html><?php /**PATH D:\xampp\htdocs\gtn_bootcamp_undiksha_2021\Project_2015101013_I Gede Arya Winata\resources\views/components/index.blade.php ENDPATH**/ ?>